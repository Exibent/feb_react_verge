 ...
 * Fri Dec 04 2020 00:28:53 GMT+0100 (Ora standard dell’Europa centrale)
...
var i_wool, i_cuffs, i_belt, i_collar;
...
i_wool = '0';
eventHTMLElem('click', 'color_wool_img', true, function(event) {
  if (i_wool == '0') {
...
i_cuffs = '0';
eventHTMLElem('click', 'color_cuffs_img', true, function(event) {
  if (i_cuffs == '0') {
    assignMat('bottom_border', 'cuffs_grey');
    assignMat('left_cuff', 'cuffs_grey');
    assignMat('right_cuff', 'cuffs_grey');
    i_cuffs = '1';
  } else {
    assignMat('bottom_border', 'cuffs_red');
...
i_belt = '0';
eventHTMLElem('click', 'color_belt_img', true, function(event) {
  if (i_belt == '0') {
...
i_collar = '0';
eventHTMLElem('click', 'color_collar_img', true, function(event) {
  if (i_collar == '0') {
